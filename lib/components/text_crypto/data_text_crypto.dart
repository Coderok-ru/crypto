...
class DataTextCrypto extends StatelessWidget {
  final TextEncryptionController controller = Get.find();

  DataTextCrypto({super.key});
                  ...
                  return Column(
                    children: [
                      ...
                      height: MediaQuery.of(context).size.height * 0.55,
                        child: TextField(
                          controller: TextEditingController(text: controller.encryptedText.value),
